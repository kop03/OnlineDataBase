...
public class DwdBaseLog extends BaseAPP {
    ...
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> stream) {
        ...
        SingleOutputStreamOperator<JSONObject> isNewFixStream =isNewFixStream(keyedStream);
//        isNewFixStream.print();
        ...
        return isNewFixStream.process(new ProcessFunction<JSONObject, String>() {
            ...
            public void processElement(JSONObject value, Context ctx, Collector<String> out) throws Exception {
                ...
                if (start != null) {
                    ...
                    // 当前为页面日志 页面日志中有的包含曝光信息 有的没有曝光信息 所以不能直接取value的数据
    ...
    public SingleOutputStreamOperator<JSONObject> isNewFixStream(KeyedStream<JSONObject, String> keyedStream) {
            ...
            public void processElement(JSONObject value, Context ctx, Collector<JSONObject> out) throws Exception {
                ...
                if ("1".equals(is_new)) {
                    ...
                    if (firstLoginDt == null) {
                        // 老用户 flink实时数仓里面还没有记录这个访客 需要补充访客的信息
